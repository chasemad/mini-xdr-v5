              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {filteredIncidents.map((incident) => (
                    <div
                      key={incident.id}
                      className="bg-gray-800/50 border border-gray-700/50 hover:border-gray-600/50 rounded-xl p-6 cursor-pointer transition-all duration-200 hover:bg-gray-800/70"
                    ...
                    >
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-3 text-sm text-gray-400">
                              <span>Source: {incident.src_ip}</span>
                              <span>•</span>
                        ...
                        <div className="flex items-center gap-2">
                          {incident.triage_note && (
                            <span className={`px-3 py-1 rounded-full text-xs font-semibold ${getSeverityColor(incident.triage_note.severity)}`}>
                      ...
                      <p className="text-sm text-gray-300 mb-4">{incident.reason}</p>
