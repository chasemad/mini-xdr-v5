...
class ComprehensiveAttackTester:
        ...
        for scenario in attack_scenarios:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    incidents = await self._get_incidents_for_ip(client, scenario['src_ip'])
                    ...
                    if incidents:
                        ...
                        threat_type = incident.get('threat_classification', {}).get('threat_type', 'Unknown')
                        confidence = incident.get('threat_classification', {}).get('confidence', 0)
                        ...
                        self.results.append({
                            ...
                            "match": scenario['expected_class'].lower() in threat_type.lower()
                        })
                        ...
                        print(f"     ⚠️  No incident created (might be below threshold)")
                else:
    ...
    async def test_model_classifications(self, client: httpx.AsyncClient):
        ...
        for result in self.results:
            ...
            print(f"  {result['scenario']:<25} {result['threat_type']:<25} "
    ...
    async def _get_incidents_for_ip(self, client: httpx.AsyncClient, src_ip: str) -> List[Dict]:
    ...
    def print_summary(self):
        ...
        print("  4. If model stuck at 57%, run: python tests/test_model_confidence_debug.py")
        print()
