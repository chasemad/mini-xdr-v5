...
class HistoricalDataImporter:
    def __init__(self, base_url: str = BASE_URL, agent_profile: str | None = None):
        ...
        self.session.headers.update({'User-Agent': 'Mini-XDR-HistoricalImporter/1.0'})
...
async def main():
    ...
    parser.add_argument("--agent-profile", default=None, help="Agent credential profile (default: MINIXDR_AGENT_PROFILE or HUNTER)")

    args = parser.parse_args()

    importer = HistoricalDataImporter(agent_profile=args.agent_profile)
    ...
    print("\n🎯 Next Steps:")
    print("   • Check status: python scripts/ml-training/optimize-training.py --mode status")
    print("   • Generate more data: python scripts/ml-training/generate-training-data.py")
