...
async def main():
    ...
    if args.mode == "status":
        ...
        print("   • Run continuous training: python scripts/ml-training/optimize-training.py --mode continuous")
        print("   • Monitor with: python scripts/ml-training/optimize-training.py --mode status")
